...
class BookListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'category_name', 'isbn', 'price', 'cover_image',
            'is_issued', 'quantity', 'created_at', 'updated_at', 'available_quantity'
        ]
...
class IssuedBookSerializer(serializers.ModelSerializer):
    ...
    student_mobile=serializers.IntegerField(source='student.mobile',read_only=True)
    book_title=serializers.CharField(source='book.title',read_only=True)
    book_isbn=serializers.CharField(source='book.isbn',read_only=True)
    book_cover=serializers.ImageField(source='book.cover_image',read_only=True)
    class Meta:
        model=IssuedBook
        fields=['id','book','book_title','student','student_id','book_isbn',
                'book_cover','student_name','issued_at','return_at','is_returned',
                'fine','remark','created_at','updated_at','student_email','student_mobile']        